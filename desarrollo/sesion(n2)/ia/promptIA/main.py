...
# En este caso, se accede problemas/problema1.txt, que debe contener una pregunta algorítmica en texto plano
# El modo "r" indica modo lectura, y encoding="utf-8" asegura compatibilidad con caracteres especiales
with open("problemas/reto2.txt", "r", encoding="utf-8") as f:
